...
public class Dot {
    ...
    public static void showString(String file, String string)  {
        try {
            ...
            TGConsole.out.println("Unable to save graph to the file "+ file + "\nReason: " + exx.toString() );
        }
    }
    ...
    public static void showDot(String file) {
        ...
        try {
            ...
            TGConsole.out.println("Unable to run DOT on " + file + "\nReason: " + exx.toString() );
        }catch(InterruptedException exx) {
            TGConsole.out.println("DOT interrupted when processing " + file + "\nReason: " + exx.toString() );
        }
    }
